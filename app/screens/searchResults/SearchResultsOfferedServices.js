        ...
        return (
            posts.map((post) => (
                <TouchableOpacity
                    ...
                    key={post.post_id}
                    onPress= {() => {console.log("show me this post, the DETAILS PLS"), LoadComponent(post)}}>
                    <Grid>
                        {/* image */}
...
export default function SearchResultsOfferedServices (props) {
