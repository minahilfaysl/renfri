...
const TrackingSystemBuyerPovNotifsOS = ({navigation}) => {
    ...
    return (
        ...
        <SafeAreaView style={styles.overall}>
            <View style={styles.overall}>
                ...
                <StatusBar backgroundColor="#C7C4AC" />
                ...
                <ScrollView style = {styles.form_container}> 
                   ...
                   <View style = {styles.form_container2}>
                        ...
                        <Text style= {styles.person}>
                            ...
                            A notification has been sent to the lister that the transaction has been completed.
                            Both of your average ratings will be updated 
                            according to the ratings you received from this transaction.

                            Thank you for using RENFRI.
...
const styles = StyleSheet.create({
    ...
    completetext : {
        ...
        color : "#193E26",
        textAlign : 'left',
        marginHorizontal: 0.09 * actual_width,
        marginBottom: "7%",
    },
...
export default TrackingSystemBuyerPovNotifsOS