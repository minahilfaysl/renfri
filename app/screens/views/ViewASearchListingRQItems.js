...
import SavedButtonDRed from "../../components/SavedButtonDRed";
...
export default function ViewASearchListingRQItems (props) {
                ...
                <ScrollView style = {styles.form_container}> 
                    <View style = {styles.form_container2}>
                        ...
                        <View style={styles.button_container}>
                            <View>
                                <SavedButtonDRed state={props.data.saved_post}/>
                            </View>
