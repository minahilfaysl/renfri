...
export default function MarkAsOpenButton(props) {
    ...
    const [text, setText] = useState("MARK AS OPEN")
    ...
    const buttonClicked = {
        onPress: () => {
            if (clicked) {
                ...
                setClicked(true),
                console.log("hello mark my post as open")
            }
        },
    ...
    return (
        <TouchableOpacity {...buttonClicked}> 
            <Image 
                style={styles.icon} 
                source = {require("../assets/View_alt_fill.png")}/>
